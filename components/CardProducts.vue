    ...
    <div class="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 z-10">
      <div v-for="product in products" :key="product.id"
        ...
        <div class="p-4 flex-grow">
          ...
          <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-3 line-clamp-1">{{ product.name }}</h2>
          <p class="text-gray-600 dark:text-gray-300 text-sm mt-2 line-clamp-2">{{ product.description }}</p>
