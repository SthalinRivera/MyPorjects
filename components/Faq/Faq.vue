<template>
    <div class="my-4 ">
      <div class="">
        <h1 class="text-slate-900 dark:text-white font-bold text-3xl mb-6 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-1 after:w-20 after:bg-pink-500 after:rounded-full pb-2">
      ...
      <div class="space-y-4 max-w-4xl mx-auto px-4 py-8 sm:px-6 sm:py-12">
        <div 
        ...
        >
          ...
          >
            <div class="flex items-center gap-4">
              <div class="flex-shrink-0 w-10 h-10 rounded-full bg-pink-100 dark:bg-pink-900/50 flex items-center justify-center">
                <UIcon 
                  :name="faq.icon" 
                  class="text-lg text-pink-600 dark:text-pink-400" 
                  dynamic
                />
              </div>
  ...
  const faqs: Ref<FAQItem[]> = ref([
    ...
    icon: 'i-ri-global-line' // Icono de mundo/online
  },
  {
    ...
    icon: 'i-ri-money-dollar-circle-line' // Icono de dinero/envío
  },
  {
    ...
    icon: 'i-ri-time-line' // Icono de tiempo/reloj
  },
  {
    question: '¿Hacen envíos internacionales?',
    answer: 'No, por ahora solo trabajamos en territorio Nacional muy pronto.',
    icon: 'i-ri-plane-line' // Icono de avión/internacional
  },
  ]);
