    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2">
          <li class="inline-flex items-center">
            <NuxtLink to="/" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-pink-600 dark:text-gray-400 dark:hover:text-white">
          ...
          <li>
            <div class="flex items-center">
              ...
              <NuxtLink to="/category" class="ml-2 text-sm font-medium text-gray-700 hover:text-pink-600 dark:text-gray-400 dark:hover:text-white">
                Categorías
              </NuxtLink>
            </div>
          </li>
      ...
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-8">
        ...
        <div class="flex gap-3 w-full sm:w-auto">
          <select v-model="sortBy" class="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-pink-500 focus:border-pink-500">
      ...
      <!-- Empty State -->
      <div v-else-if="products.length === 0" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
        ...
        <NuxtLink to="/" class="inline-flex items-center px-4 py-2 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition-colors">
  ...
  />
          ...
          <div class="p-4">
            ...
            <div class="flex justify-between items-center">
              ...
              <NuxtLink :to="`/product/${product.id}`">
                <UButton
                  class="bg-gradient-to-r from-pink-500 to-pink-600 dark:from-pink-600 dark:to-pink-700 dark:text-white border-none py-2 px-3 rounded-lg hover:from-pink-600 hover:to-pink-700 dark:hover:from-pink-500 dark:hover:to-pink-600 transition-all duration-300 shadow-md hover:shadow-lg"
                >
